...
const SLUG_PREFIX = 'Clark-Huss-Rooms-';
const LOCALES = ['en', 'de', 'ja', 'ko', 'es'];
const CONTENT_TYPES = ['codes', 'guides', 'entities', 'tier-list', 'map', 'controls', 'updates', 'multiplayer', 'tools', 'comparison'];
