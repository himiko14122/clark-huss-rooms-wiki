...
export default async function CatchAllPage({ params }: { params: Promise<{ locale: string; slug: string[] }> }) {
  ...
  if (isContentType(first)) {
    ...
    const GUIDE_STOP_WORDS = new Set(['clark', 'huss', 'rooms', 'hussrooms', 'entity', 'entities', 'strategy', 'strategies', 'guide', 'tier', 'list', 'the', 'a', 'an', 'and', 'or', 'in', 'on', 'at', 'to', 'for', 'is', 'it', 'how', 'what', 'all', 'vs', 'game', 'wiki', 'best', 'beginner', 'advanced', 'roblox', 'horror', 'backrooms', 'survival', 'flashlight', 'squad', 'multiplayer']);
