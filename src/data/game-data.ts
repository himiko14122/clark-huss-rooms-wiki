...
export const entities: Entity[] = [
  ...
  {
    id: 'audio-tracking',
    nameKey: 'entity_ailment_audioTracking',
    tier: 'S',
    descKey: 'entity_audioTracking_desc',
    behaviorKey: 'entity_audioTracking_behavior',
    counterKey: 'entity_audioTracking_counter',
    audioTellKey: 'entity_audioTracking_tell',
    icon: Headphones,
  },
  {
    id: 'flashlight-spotted',
    nameKey: 'entity_ailment_flashlightSpotted',
    tier: 'A',
    descKey: 'entity_flashlightSpotted_desc',
    behaviorKey: 'entity_flashlightSpotted_behavior',
    counterKey: 'entity_flashlightSpotted_counter',
    audioTellKey: 'entity_flashlightSpotted_tell',
    icon: Battery,
  },
  {
    id: 'line-of-sight',
    nameKey: 'entity_ailment_lineOfSight',
    tier: 'A',
    descKey: 'entity_lineOfSight_desc',
    behaviorKey: 'entity_lineOfSight_behavior',
    counterKey: 'entity_lineOfSight_counter',
    audioTellKey: 'entity_lineOfSight_tell',
    icon: Eye,
  },
  {
    id: 'breathing-cadence',
    nameKey: 'entity_ailment_breathingCadence',
    tier: 'A',
    descKey: 'entity_breathingCadence_desc',
    behaviorKey: 'entity_breathingCadence_behavior',
    counterKey: 'entity_breathingCadence_counter',
    audioTellKey: 'entity_breathingCadence_tell',
    icon: Radio,
  },
  {
    id: 'server-locked',
    nameKey: 'entity_ailment_serverLocked',
    tier: 'S',
    descKey: 'entity_serverLocked_desc',
    behaviorKey: 'entity_serverLocked_behavior',
    counterKey: 'entity_serverLocked_counter',
    audioTellKey: 'entity_serverLocked_tell',
    icon: Lock,
  },
];
